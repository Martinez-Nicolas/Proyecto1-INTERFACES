...
def procesar_figura_1b(ruta_imagen):
    """
    Procesa la Figura 1b y calcula:
    a. El Momento de Orden m(p=2,q=1) (Ver 2.15).
    b. El Momento Central de Orden μ(p=2,q=1) (Ver 2.21).
    c. El Momento Central Normalizado de Orden η(p=2,q=1) (Ver 2.23).
    """
